 ...
 */
class Receta extends \Daw\DietaBundle\Entity\Receta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titulo', 'descripcion', 'fechapub', 'img', 'autor');
        }
