 ...
 */
class Articulo extends \Daw\DietaBundle\Entity\Articulo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titulo', 'descripcion', 'tipo', 'fuente', 'fechapub', 'img');
        }
    ...
    public function setFechapub()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechapub', array());

        return parent::setFechapub();
    }
